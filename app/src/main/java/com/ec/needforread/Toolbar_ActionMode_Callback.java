...
public class Toolbar_ActionMode_Callback implements ActionMode.Callback {
        ...
        switch (item.getItemId()) {
            case R.id.action_delete:
                ...
                if (isListViewFragment) {
                    Fragment listFragment = new NeedForReadActivity().getFragment(0);//Get list view Fragment
                    ...
                    Fragment recyclerFragment = new NeedForReadActivity().getFragment(1);//Get recycler view fragment
    ...
    public void onDestroyActionMode(ActionMode mode) {
        ...
        if (isListViewFragment) {
            ...
            Fragment listFragment = new NeedForReadActivity().getFragment(0);//Get list fragment
            if (listFragment != null)
            ...
            Fragment recyclerFragment = new NeedForReadActivity().getFragment(1);//Get recycler fragment
            if (recyclerFragment != null)
